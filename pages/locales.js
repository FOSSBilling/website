  ...
  return (
    <PageLayout locales title="Select your language">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-6 flex max-w-4xl bg-gray-50 border rounded-xl flex-wrap items-center justify-around sm:w-full">
          {localeButtons}
        </div>
        {/* Ending of the list */}
        <a href="https://github.com/fOSSBilling/website#localization" target="_blank" rel="noopener" className="mt-3 text-gray-600 hover:text-blue-700">Help us with the translations</a>
